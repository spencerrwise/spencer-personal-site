...
Webflow.define('ix', function ($, _) {
  ...
  function build(i, el) {
    ...
    if (setStyles) style(el, ix.style);
  ...
  // Set styles immediately on specified element
